...
<main class="hilife-main">
        ...
        ?>
            <a href="<?php echo esc_url($intersection_url); ?>"
               style="position:relative;overflow:hidden;aspect-ratio:3/2;display:block;border:1px solid var(--border);text-decoration:none;">
                ...
                <div style="position:absolute;top:0;left:0;right:0;height:2px;background:var(--gold);transform:scaleX(0);transform-origin:left;transition:transform 0.3s;" class="occasion-bar"></div>
                <div style="position:absolute;bottom:0;left:0;right:0;padding:20px 22px;">
                    ...
                    <div style="font-size:10px;letter-spacing:0.15em;text-transform:uppercase;color:var(--gold);font-family:var(--font-body);">in <?php echo esc_html($term->name); ?> →</div>
                </div>
            </a>
        <?php endforeach; ?>
        </div>
    ...
    <div style="padding:48px 40px;border-top:1px solid var(--border);background:var(--surface);display:flex;align-items:center;justify-content:space-between;gap:32px;">
        <div>
            <div style="font-size:10px;letter-spacing:0.25em;text-transform:uppercase;color:var(--gold);font-family:var(--font-body);margin-bottom:8px;">Planning an event in <?php echo esc_html($term->name); ?>?</div>
