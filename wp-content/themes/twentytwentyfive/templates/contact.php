...
<main class="hilife-main">
    ...
    <div style="display:grid;grid-template-columns:1fr 1.6fr;gap:2px;min-height:600px;">
        ...
        <div style="background:var(--panel);border-right:1px solid var(--panel-border);padding:48px 40px;">
            ...
            <div style="font-size:13px;color:var(--text-dim);line-height:1.8;margin-bottom:32px;font-style:italic;padding:16px 20px;border-left:2px solid var(--accent);background:var(--surface2);">
            ...
            <div style="margin-bottom:32px;">
                <div style="display:flex;align-items:flex-start;gap:16px;padding:14px 0;border-bottom:1px solid rgba(58,58,56,0.5);">
                    ...
                    <a href="tel:07828688144" style="font-size:14px;color:var(--accent);text-decoration:none;">07828 688144</a>
                </div>
                <div style="display:flex;align-items:flex-start;gap:16px;padding:14px 0;border-bottom:1px solid rgba(58,58,56,0.5);">
        ...
        <div style="background:var(--panel);border-left:1px solid var(--panel-border);padding:48px 40px;">
            ...
            <style>
                .hilife-contact-form input::placeholder,
                .hilife-contact-form textarea::placeholder {
                    color: var(--text-dim);
                    opacity: 1;
                }
            </style>
            <form class="hilife-contact-form" name="enquiry-form" action="/actions/event" method="post" novalidate>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:2px;">
                    <div style="border-bottom:1px solid var(--panel-border);padding:16px 0;padding-right:24px;">
                        ...
                        <input type="text" name="event[primary_contact]" required maxlength="60" pattern="[ a-zA-Z\-]+"
                               ...
                               style="background:transparent;border:none;outline:none;color:var(--panel-text);font-family:var(--font-body);font-size:14px;font-weight:300;width:100%;">
                    </div>
                    <div style="border-bottom:1px solid var(--panel-border);padding:16px 0;padding-left:24px;">
                        <label style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--panel-text);margin-bottom:8px;display:flex;align-items:center;gap:6px;font-family:var(--font-body);">Email address <span style="color:var(--gold);">*</span></label>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:2px;">
                    ...
                    <div style="border-bottom:1px solid var(--panel-border);padding:16px 0;padding-left:24px;">
                        <label style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--panel-text);margin-bottom:8px;display:block;font-family:var(--font-body);">Event type</label>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:2px;">
                    ...
                    <div style="border-bottom:1px solid var(--panel-border);padding:16px 0;padding-left:24px;">
                        <label style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--panel-text);margin-bottom:8px;display:block;font-family:var(--font-body);">Venue address</label>
                ...
                <!-- Additional info -->
                <div style="border-bottom:1px solid var(--panel-border);padding:16px 0;">
                    <label style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--panel-text);margin-bottom:8px;display:block;font-family:var(--font-body);">Additional information</label>
                    <textarea name="admin[notes]" maxlength="300"
                              ...
                              style="background:transparent;border:none;outline:none;color:var(--panel-text);font-family:var(--font-body);font-size:14px;font-weight:300;width:100%;resize:none;min-height:80px;line-height:1.7;"></textarea>
                </div>
