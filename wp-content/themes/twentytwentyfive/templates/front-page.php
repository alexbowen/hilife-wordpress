...
<main class="hilife-main">
    ...
    <div style="padding:72px 40px 64px;border-bottom:1px solid var(--border);position:relative;overflow:hidden;background:linear-gradient(135deg,var(--surface) 0%,var(--black) 60%,#1c1a0c 100%);<?php echo $has_hero ? 'min-height:420px;display:flex;align-items:flex-end;' : ''; ?>">
        ...
        <div style="position:relative;max-width:700px;">
            ...
            <p style="font-size:14px;color:var(--panel-text);line-height:1.8;margin-bottom:32px;font-family:var(--font-body);font-weight:300;max-width:480px;">
            ...
            <a href="/contact" style="display:inline-block;background:var(--gold);color:#0F0F0E;font-family:var(--font-mark);font-size:13px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;padding:13px 28px;text-decoration:none;">Get in touch</a>
        </div>
    </div>
    ...
    <div style="padding:48px 40px;border-bottom:1px solid var(--border);">
        ...
        ?>
            <a href="<?php echo esc_url($link); ?>" style="position:relative;overflow:hidden;aspect-ratio:4/3;display:block;border:1px solid var(--panel-border);background:var(--panel);text-decoration:none;transition:border-color 0.3s;"
               ...
               onmouseout="this.style.borderColor='var(--panel-border)';var i=this.querySelector('.card-img');if(i)i.style.filter='brightness(0.75)';this.querySelector('.card-title').style.color='var(--panel-text)';this.querySelector('.card-link').style.color='var(--accent)'">
                <?php if ( $image ) : ?>
                ...
                <div style="position:absolute;bottom:0;left:0;right:0;padding:24px;">
                    ...
                    <?php endif; ?>
                    <span class="card-link" style="font-size:11px;letter-spacing:0.12em;text-transform:uppercase;color:var(--accent);font-family:var(--font-body);transition:color 0.3s;">Find out more →</span>
                </div>
            </a>
        <?php endforeach; ?>
        </div>
