...
<!-- HERO -->
    ...
    <div style="padding:48px 40px;border-bottom:1px solid var(--border);">
        ...
        ?>
            <a href="<?php echo esc_url($link); ?>" style="position:relative;overflow:hidden;aspect-ratio:16/9;display:block;border:1px solid var(--border);text-decoration:none;">
                ...
                <?php endif; ?>
                <div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(26,22,18,0.95) 0%,rgba(26,22,18,0.3) 60%,transparent 100%);"></div>
                <div style="position:absolute;bottom:0;left:0;right:0;padding:20px 24px;">
                    <div style="font-family:var(--font-display);font-size:20px;font-weight:400;color:var(--text-bright);margin-bottom:6px;"><?php echo esc_html($occasion->name); ?></div>
                    <div style="font-size:11px;color:var(--text-dim);line-height:1.6;font-family:var(--font-body);font-weight:300;margin-bottom:12px;"><?php echo esc_html($occasion->description); ?></div>
    ...
    <div style="padding:48px 40px;background:var(--surface);border-bottom:1px solid var(--border);">
        ...
        ?>
            <a href="<?php echo esc_url($link); ?>" style="position:relative;overflow:hidden;padding:28px 26px;border:1px solid var(--border);min-height:160px;display:block;text-decoration:none;transition:border-color 0.3s;"
               ...
               onmouseout="this.style.borderColor='var(--border)'">
                ...
                <div style="position:relative;">
                    <div style="font-family:var(--font-display);font-size:17px;font-weight:400;color:var(--text-bright);margin-bottom:8px;"><?php echo esc_html($service->name); ?></div>
    ...
    <div style="padding:32px 40px;background:var(--dark);border-bottom:1px solid var(--border);">
        <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
            <span style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--gold);font-family:var(--font-body);margin-right:12px;white-space:nowrap;">Areas we cover</span>
            <?php foreach ( $locations as $loc ) : ?>
                <a href="<?php echo esc_url(get_term_link($loc)); ?>"
                   style="font-size:10px;letter-spacing:0.08em;text-transform:uppercase;color:var(--text-dim);border:1px solid var(--border);padding:7px 16px;font-family:var(--font-body);text-decoration:none;transition:all 0.2s;"
    ...
    <div style="padding:48px 40px;border-bottom:1px solid var(--border);">
        ...
        ?>
            <div style="background:var(--surface);border:1px solid var(--border);padding:18px 24px;display:flex;gap:16px;align-items:flex-start;">
    ...
    <div style="padding:48px 40px;background:var(--surface);border-bottom:1px solid var(--border);">
        ...
        ?>
            <div style="background:var(--dark);border:1px solid var(--border);padding:28px;position:relative;">
                ...
                <p style="font-size:13px;line-height:1.9;color:var(--text);font-style:italic;margin-bottom:16px;"><?php echo esc_html(get_the_content()); ?></p>
